            ...
            <div class="content bg-white">
              <div ref="tab-current">
                <div class="row gutter no-margin lt-md-column">
                  ...
                  <div class="width-1of4 sm-auto sm-wrap" v-for="enrollment in enrollments.in_progress" v-else>
              ...
              <div ref="tab-complete">
                <div class="row gutter no-margin lt-md-column">
                  ...
                  <div class="width-1of4 sm-auto sm-wrap" v-for="enrollment in enrollments.completed" v-else>
